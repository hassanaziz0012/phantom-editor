...
def query_browserllm_claude(
    ...
    """
    Executes BrowserLLM with provider Claude in headful mode.
    Passes prompt via temporary file for safe handling of multi-line texts.
    """
    ...
    try:
        ...
        logger.info("Executing BrowserLLM Claude query (headful mode)...")
