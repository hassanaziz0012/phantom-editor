...
### [count_youtube_uploads.py](file:///home/hassan/programming/phantom-editor/youtube_api/count_youtube_uploads.py)
...
* **Usage**: `python youtube_api/count_youtube_uploads.py [<channel_id_or_handle>] [--fresh]` or via `phantom youtube count-uploads [<channel>] [--fresh]`

### [create_metadata.py](file:///home/hassan/programming/phantom-editor/youtube_api/create_metadata.py)
Interactively prompts for and creates a `metadata.json` file used when uploading a video.
* **Usage**: `python youtube_api/create_metadata.py /path/to/video.mp4` or via `phantom youtube create-metadata <video_path>`

### [fetch_videos.py](file:///home/hassan/programming/phantom-editor/youtube_api/fetch_videos.py)
...
### [models.py](file:///home/hassan/programming/phantom-editor/youtube_api/models.py)
Defines shared dataclasses (`Video`, `VideoSeed`, `RankedVideo`) for storing video metadata, stats, and recommendation rankings.

### [recommend_related_videos.py](file:///home/hassan/programming/phantom-editor/youtube_api/recommend_related_videos.py)
Calculates and lists recommended related videos from the channel inventory using a weighted similarity algorithm.
* **Usage**: `python youtube_api/recommend_related_videos.py (--metadata <path> | --video-id <id>) [--limit <int>] [--json]` or via `phantom youtube recommend-related`

### [upload_video.py](file:///home/hassan/programming/phantom-editor/youtube_api/upload_video.py)
...
* **Usage**: `python youtube_api/upload_video.py /path/to/video.mp4` or via `phantom youtube upload <video_path>`

### [utils.py](file:///home/hassan/programming/phantom-editor/youtube_api/utils.py)
