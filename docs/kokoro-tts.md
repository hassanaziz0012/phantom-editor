...
## Model
* **[Kokoro-82M/](file:///home/hassan/programming/phantom-editor/kokoro-tts/Kokoro-82M)**: A lightweight, open-weight TTS model (82M parameters) that delivers high-quality, fast, and cost-efficient speech synthesis.

## Scripts

### [demo.py](file:///home/hassan/programming/phantom-editor/kokoro-tts/demo.py)
...
### [makesound.py](file:///home/hassan/programming/phantom-editor/kokoro-tts/makesound.py)
...
### [savesound.py](file:///home/hassan/programming/phantom-editor/kokoro-tts/savesound.py)
